        ...
        $ocLazyLoadProvider.config({
            ...
            modules: [
                ...
                // }, 
                {
                    name: 'dataTables',
                    files: [
                        'vendor/jquery-datatable/media/css/dataTables.bootstrap.min.css',
                        'vendor/jquery-datatable/extensions/FixedColumns/css/dataTables.fixedColumns.min.css',
                        'vendor/datatables-responsive/css/datatables.responsive.css',
                        'vendor/jquery-datatable/media/js/jquery.dataTables.min.js',
                        'vendor/jquery-datatable/extensions/TableTools/js/dataTables.tableTools.min.js',
                        'vendor/jquery-datatable/media/js/dataTables.bootstrap.js',
                        'vendor/jquery-datatable/extensions/Bootstrap/jquery-datatable-bootstrap.js',
                        'vendor/datatables-responsive/js/datatables.responsive.js',
                        'vendor/datatables-responsive/js/lodash.min.js'
                    ],
                    serie: true // load in the exact order
                },
                // {
