        ...
        function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $httpProvider, $locationProvider) {
            ...
            $stateProvider
                .state('app', {
                    ...
                    url: '/privilege',
                    templateUrl: 'tpl/extra_login_privalge.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load([
                                        'assets/js/controllers/authprivlageUser.js'
                                    ]);
                                });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load([
                                        'assets/js/controllers/controlroom.js'
                                    ]);
                                });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load([
                                        'assets/js/controllers/gurdDashboard.js'
                                    ]);
                                });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/realtimeevents.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function() {
                                    return $ocLazyLoad.load('assets/js/controllers/healthManagement.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function() {
                                    return $ocLazyLoad.load('assets/js/controllers/beaconbatteryStatus.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/deviceconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/busconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/assettypeconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/subtypeconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/companyconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/zoneconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/networkconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/floorconfig.js');
                                });
                        }]
                    }
                })
                ...
                .state('app.deviceAndAssetProvi', {
                    url: "/provisioning",
                    templateUrl: "tpl/device&assetProvi.html",
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function() {
                                    return $ocLazyLoad.load('assets/js/controllers/deviceAssetProvi.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function() {
                                    return $ocLazyLoad.load('assets/js/controllers/ruleSetup.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/foodcartconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/floorLayout.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/empconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/mapconfig.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/userzonemapping.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/assetDevicemap.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/assetZonemap.js');
                                });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/zoneDetail.js');
                                });
                        }]
                    }
                })               
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function () {
                                    return $ocLazyLoad.load('assets/js/controllers/reporting.js');
                                });
                        }]
                    }
                })
                ...
                //                 })
                //                 .then(function () {
                //                     return $ocLazyLoad.load('assets/js/controllers/reportingTimespent.js');
                //                 });
                //         }]
                //     }
                // })
                ...
                //                 })
                //                 .then(function () {
                //                     return $ocLazyLoad.load('assets/js/controllers/reportingTimespentAllowedZone.js');
                //                 });
                //         }]
                //     }
                // })
