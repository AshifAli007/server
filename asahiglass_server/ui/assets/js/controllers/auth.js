...
angular.module('app')
    // Chart controller
    .controller('AuthCtrl', ['$scope', 'md5', '$rootScope', '$http', 'sessionInjector', 'Config', '$timeout', '$location', '$window', 'toaster',
        function ($scope, md5, $rootScope, $http, sessionInjector, config, $timeout, $location, $window, toaster) {
