...
/* Controllers */
angular.module('app')
    .controller('HealthManagement', ['$scope', 'md5', 'socketIO', '$rootScope', '$http', 'sessionInjector', 'Config', 'Sessioncheck', '$timeout', '$location', '$window',
                ...
                $http.get(config.host + '/device/devicehealth')
                    .then(function (res) {
                        if (res.data.success == true) {
                            ...
                            var table = $('#healthMgtTable').DataTable({
