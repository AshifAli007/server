 ...
 * @apiParam  {Integer}         userType  We have three type of user type admin(0), company admin(1), employees (2)
 * @apiParam  {Integer}         contactno User's Contact no.
 * @apiParam  {String{6..100}}  [address]   User's Address  
 * @apiParam  {String{6..128}}  password  User's password
 * @apiParam  {String{6..100}}  fullname  User's fullname
 *

 * @apiSuccess (Created 201) {String}  token.accessToken   Authorization Token


 * @apiSuccess (Created 201) {Integer} user.status          api status
...
router.route('/register')
  .post(validate(register), controller.registerPrivilege);
